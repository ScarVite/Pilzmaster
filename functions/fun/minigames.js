...
module.exports = {
    reaction: function (message) {
        ...
        message.channel.send(locales.minigames.dice.ready).then(function (message) {
            setTimeout(function () { message.edit(locales.minigames.dice.steady) }, 5000)
            setTimeout(function () { message.edit(locales.minigames.dice.go) }, 10000)
    ...
    diceroll: function (message) {
        ...
        switch (dice) {
            ...
            case 6:
                ...
                break;
            default:
                message.channel.send(locales.minigames.dice.dice-message1 + dice + locales.minigames.dice.dice-message2)
                break;
        }
    },
